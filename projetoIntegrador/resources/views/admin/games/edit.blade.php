    ...
    @section('title', 'Editar Jogo: ' .$game->title  .$game->id)
...
--}}
<form class="form-carrossel" action="{{ route('admin.games.update', $game) }}" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    ...
    <button class="btn-create" type="submit">Atualizar Jogo</button>
